...
The data included in this package is redistributed from the FAOSTAT statistical database, 
...
Database: FAOSTAT - Food Balances (-2013, old methodology and population), Food Balances (2010-)

Dataset Last Updated: [2023]

Accessed Date: [October 2025]
...
Disclaimer:
The Food and Agriculture Organization (FAO) does not endorse the views, products, 
or services contained within this software package. The user assumes all risk resulting 
from the use or modification of this data.
